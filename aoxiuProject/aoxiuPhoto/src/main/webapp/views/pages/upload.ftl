...
<div class="container">
	<div class="text-left col-md-12 wrapper">
        ...
        <input type="hidden" id="domain" value="http://7xis67.com2.z0.glb.qiniucdn.com/">
        <input type="hidden" id="uptoken_url" value="/pictures/getToken?type=0">
...
<script type="text/javascript" src="../js/main-upload.js"></script>
</body>
</html>
