...
FileProgress.prototype.setComplete = function(up, info, completeCallback) {
    ...
    var isImage = function(url) {
        var res, suffix = "";
        var imageSuffixes = ["png", "jpg", "jpeg", "gif", "bmp", 'ico'];
    ...
    if (!isImg) {
        ...
        $(img).on('load', function() {
            ...
            showImg.attr('src', defaultSrc);
            Wrapper.addClass('default');
        });
    }
    
    completeCallback(src || url); // 修复不是图片不能展现
};
